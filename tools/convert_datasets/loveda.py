...
#     new_file = file
#     # new_file = file.replace('.png', '_lr.png')
#     # new_file = "/home/heda/xjq/Research/Data/Segmentation/LoveDA/label_convert/" + new_file.split("/")[-1]
...
#         description='Convert whdld annotations to TrainIds')
#     parser.add_argument('gta_path', help='gta data path')
#     parser.add_argument('--gt-dir', default='label_convert', type=str)
