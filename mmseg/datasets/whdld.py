...
class WHDLDataset(CustomDataset):
    """LoveDA dataset.
    ...
    """
    # CLASSES = ('building', 'road', 'pavement', 'vegetation', 'bare land', 'water', 'background')

    # PALETTE = [[255, 0, 0], [255, 255, 0], [168, 168, 0], [85, 255, 0],
    #            [156, 156, 156], [0, 92, 230], [0, 0, 0]]

    CLASSES = ('background', 'building', 'road', 'water', 
               'barren', 'forest', 'agricultural')

    PALETTE = [[225, 225, 225], [155, 36, 22], [168, 168, 0], [10, 78, 151],
               [200, 200, 200], [0, 123, 79],  [254, 195, 124]]
    
    # PALETTE = [[255, 255, 255], [255, 0, 0], [255, 255, 0], [0, 0, 255],
    #            [159, 129, 183], [0, 255, 0], [255, 195, 128]]
    
    def __init__(self, **kwargs):
        super(WHDLDataset, self).__init__(
            img_suffix='.png',
            seg_map_suffix='.png',
            **kwargs)
